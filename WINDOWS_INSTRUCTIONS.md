...
## ❗️ Kaspersky and McAfee Anti-Virus Note ❗️

**Kaspersky** Lab Anti-Virus and **McAfee** Anti-Virus have been known to cause problems with Windows Subsystem for Linux. Specifically, they block secure downloads of common tools included in this environment setup.

If you are using Kasperksy Lab Anti-Virus, Kaspersky Internet Security Software, or McAfee Anti-Virus, then you must uninstall it to continue.

After uninstalling, you _must_ restart your machine.
...
The issue is somewhat [known by McAfee](https://kc.mcafee.com/corporate/index?page=content&id=KB91411) as well.
